        ...
        <>
            <div className="flex flex-row justify-between w-full">
                <div className="flex flex-col w-full relative">
                    ...
                    <div
                        className={`py-3 my-2 bg-theme-brown-100 transition-all duration-200 ${
                            !openFilters
                    ...
                    >
                        {headerGroups.map(
                            (headerGroup, headerGroupIdx) => (
                                <div
                                    key={headerGroupIdx}
                                    className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-white rounded-md shadow-lg py-5"
                                >
            ...
            <div className="overflow-x-auto overflow-y-hidden ">
                ...
                >
                    <thead className="bg-theme-blue-300 h-16 shadow-lg text-white">
                        {headerGroups.map(
                            (headerGroup, headerGroupIdx) => (
                                <tr
